...
/* ── format panel (output format + max dim) ── */
#formatLabel {{
    color: {INK_700};
    font-size: 11px;
    font-weight: 700;
...
QPushButton#fmtChip:hover {{
    background: white;
    color: {INK_900};
}}
QPushButton#fmtChip[active="true"] {{
    background: white;
    color: {ACCENT_DK};
    border: 1px solid {ACCENT};
}}
QCheckBox#maxDimCheck {{
    color: {INK_700};
    font-size: 11px;
    spacing: 6px;
}}
QCheckBox#maxDimCheck::indicator {{
    width: 14px;
    height: 14px;
...
QCheckBox#maxDimCheck::indicator:checked {{
    background: {ACCENT};
    border: 1px solid {ACCENT};
    image: none;
}}
QLineEdit#maxDimEdit {{
    background: white;
    border: 1px solid {INK_200};
    border-radius: 4px;
    padding: 4px 6px;
...
QLineEdit#maxDimEdit:focus {{
    border: 1px solid {ACCENT};
}}
QLineEdit#maxDimEdit:disabled {{
